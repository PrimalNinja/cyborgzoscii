...
!0).text("Encoding...");var b=$("#encodingSelect").val(),c=null,a;16===g_BITTAGE?a=65536:32===g_BITTAGE&&(a=4294967296);var e=g_arrRomData.length;e>a&&(e=a);a=[{start:0,size:e}];"petscii"===b?c=petsciiToAscii:"ebcdic"===b&&(c=ebcdicToAscii);c=toZOSCII(g_arrRomData,g_strTextData,a,c,42,g_BITTAGE);g_objEncodingResult={success:!0,addresses:c.addresses,originalText:g_strTextData,encoding:b,addressCount:c.addresses.length,inputCounts:c.inputCounts,romCounts:c.romCounts};displayAnalysis(g_objEncodingResult);
$("#analysis-tab").click();$(this).prop("disabled",!1).text("Encode")}})}function setupDropZone(b,c){var a=$(b);a.on("dragover",function(a){a.preventDefault();$(this).addClass("dragover")});a.on("dragleave",function(a){a.preventDefault();$(this).removeClass("dragover")});a.on("drop",function(a){a.preventDefault();$(this).removeClass("dragover");a=a.originalEvent.dataTransfer.files;0<a.length&&c(a[0])})}
